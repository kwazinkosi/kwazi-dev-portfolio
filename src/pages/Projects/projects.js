  ...
  return (
    <div  className="flex flex-col min-h-screen z-10 bg-gradient-to-b from-tertiary1 to-tertiary2 flex-grow w-full">
      ...
      <div className="flex flex-col items-center justify-center text-center flex-1 p-8 mx-4 sm:mx-12 md:mx-16 lg:mx-24 text-white my-24 md:my-36 lg:my-40">
        <h1 className="portfolio font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl">My Projects</h1>
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl">Here are some of the projects I've worked on.</p>
      </div>
